...
from
	mhea_master.am_employee as e
	left join mhea_master.am_designation as d on e.designation_id = d.id
	left join mhea_master.am_employee_type as et on e.employee_type_id = et.id
where
	enterprise_id = 8
	OR enterprise_id = 2
order by
